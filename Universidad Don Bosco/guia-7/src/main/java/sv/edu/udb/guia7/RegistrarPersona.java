    ...
    private void processRequest(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                // Añade esta parte para obtener el rol del formulario
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h1 class='text-center'>Usted ha registrado exitosamente</h1>");
                ...
                out.println("<h3>Rol: </h3>" + rol); // Muestra el rol
